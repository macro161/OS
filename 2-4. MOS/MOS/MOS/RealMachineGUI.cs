...
namespace MOS // INotify property https://docs.microsoft.com/en-us/dotnet/framework/wpf/data/how-to-implement-property-change-notification
{
    public partial class RealMachineGUI : Form
    {
        ...
        {
            //VirtualMachine vm = new VirtualMachine(rm.GetMemory(), 0);
        }
        ...
        private string JoinStrings(string[,] data, int blockNumber)
        {
            ...
            //MessageBox.Show(data[0,0] + "nigger"); //ups
