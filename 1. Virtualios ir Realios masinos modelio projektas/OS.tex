...
\end{figure}
	...
	Virtualios mašinos atmintis susideda iš 16 blokų po 16 žodžių iš viso 256 žodžiai po 4 baitus arba 32 bitus. Nuo 1 iki 5 bloko yra duomenų segmentas(DS) ir nuo 6 iki 16 kodo segmentas(CS). Norint pasinaudoti puslapiavimo mechanizmu realios mašinos atmintyje yra išskiriamas vienas takelis Virtualios-realos mašinos adresams saugoti. Naudosime registrą PTR(4 baitai a0 a1 a2 a3) kuriame laikomas puslapių lentelės bloko realus adresas. Per a2 ir a3 surandame bloką. Pagal x1 ir x2 nustatomas puslapis. Bloko adresas, kur yra x1 randamas pagal formulę [16*(16*a2 a3)+x1]x2, o prie bloko adreso pridėjus x2 gauname vistualų adresą 16*[16*(16*a2 a3)+x1]x2 .Efektyviai naudotis Virtualia atmintimi įvesime du papildomus registus DS ir CS. DS registro reikšmė bus rodyklė į duomenų segmento atmintį, o CS reišmė rodyklė į kodo segmento atmintė.
