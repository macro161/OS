...
Puslapiavimo mechanizmas yra metodas skirtas virtualios atminties adreso parodymui į realios atminties adresą. Kiekvienai virtualiai mašinai skiriama 16 atminties blokų. Sukuriant virtualią mašiną sukuriama puslapių lentelė. Naudojamas PTR(4 baitų a0,a1,a2,a3) registras kuriame laikomas puslapių lentelės adresas. Baitas a0 yra nenaudojamas, a1 puslapių lentelės ilgis
atėmus 1 o štai a2 * 10 + a3 žymi puslapių lentelės adresą. Dabar galime pateikti formulę, kuri virtualiam adresui x1x2 gražina realų adresą: Realus adresas = 10*[10*(10 * a2 + a3) + x1] + x2.
...
\newline SB: Takelio, iš kurio kopijuosime numeris.
\newline DB: Takelio, į kurį kopijuosime numeris
...
\end{figure}
	...
	Virtualios mašinos atmintis susideda iš 16 blokų po 16 žodžių iš viso 256 žodžiai po 4 baitus arba 32 bitus. Naudosime registrą PTR(4 baitai a0 a1 a2 a3) kuriame laikomas adresas į puslapių lentelę. Baitas a0 yra nenaudojamas, a1 puslapių lentelės ilgis
atėmus 1 , o
štai a2 * 10 + a3 žymi puslapių lentelės adresą. Dabar galime pateikti formulę, kuri virtualiam
...
\begin{enumerate}
\item GD – įvedimas – iš įvedimo srauto paima 16 žodžų srautą ir jį įveda į atmintį
pradedant atminties baitu 16*x1:
GD x1x2
\item PD – išvedimas – iš atminties, pradedant atminties baitu 16*x1 paima 16 žodžių
